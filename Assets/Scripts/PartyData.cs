...
{
    public delegate void PrimaryMonsterChangedHandler(MonsterData newPrimaryMonster);
    public event PrimaryMonsterChangedHandler OnPrimaryMonsterChanged;

    private MonsterData _primaryMonster;
    public MonsterData PrimaryMonster
    {
        get { return _primaryMonster; }
        set
        {
            if (_primaryMonster != value)
            {
                _primaryMonster = value;
                OnPrimaryMonsterChanged?.Invoke(_primaryMonster);
            }
        }
    }
